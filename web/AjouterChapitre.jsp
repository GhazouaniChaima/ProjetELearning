<%-- 
    Document   : AjouterChapitre
    Created on : 1 mai 2019, 17:19:23
    Author     : chaima
--%>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12 wow fadeInLeft">
                        <div class="contact-us-form">
                            ...
                            <form action="http://localhost:8080/3alemniWebsite/AjouterChapitreServlet" autocomplete="off" method="post">
                                <div class="row">
                                    <div class="col-xs-12">
