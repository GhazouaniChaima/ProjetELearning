<%-- 
    ...
    Created on : 9 avr. 2019, 01:59:26
    Author     : chaima
--%>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12 wow fadeInLeft">
                        <div class="contact-us-form">
                            ...
                            <form action="http://localhost:8080/3alemniWebsite/ajoutFormation" autocomplete="off" method="post">
                                <div class="row">
                                    <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="single-input">
                                                <input type="text" placeholder="Discipline" name="discipline">
                                            </div> <!-- /.single-input -->
                                        </div> <!-- /.col- -->
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="single-input">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="single-input">
                                                <input type="text" placeholder="Nombres modules" name="nbrmodule">
                                            </div> <!-- /.single-input -->
                                        </div> <!-- /.col- --></div>
                                    <div class="col-xs-12">
                                        <div class="single-input">
