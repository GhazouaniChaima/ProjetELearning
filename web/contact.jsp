<%-- 
    Document   : contact
    Created on : 19 avr. 2019, 13:18:17
    Author     : chaima
--%>
        ...
        <div class="main-page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 wow fadeInLeft">
                        <div class="contact-us-form">
                            ...
                            <form action="http://themazine.com/unify/campus/inc/sendemail.php" class="form-validation" autocomplete="off">
                                <div class="row">
                                    <div class="col-xs-12">
            ...
            <div>
                <div id="google-map-area">
                    <div class="google-map-two" id="contact-google-map" data-map-lat="40.925372" data-map-lng="-74.276544" data-icon-path="images/logo/map.png" data-map-title="Find Map" data-map-zoom="12"></div>
                </div>
            </div>
