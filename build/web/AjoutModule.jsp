<%-- 
    Document   : AjoutModule
    Created on : 29 avr. 2019, 11:32:20
    Author     : chaima
--%>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12 wow fadeInLeft">
                        <div class="contact-us-form">
                            ...
                            <form action="http://localhost:8080/3alemniWebsite/AjoutModuleServlet" autocomplete="off" method="post">
                                <div class="row">
                                    <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="single-input">
                                                ...
                                                <input type="text" placeholder="Nombres Chapitres" name="nbchapitre">
                                            </div> <!-- /.single-input -->
                                        </div> <!-- /.col- --></div>
                                    <div class="col-xs-12">
                                        <div class="single-input">
