<%-- 
    Document   : show_list_formation
    Created on : 19 avr. 2019, 13:20:59
    Author     : chaima
--%>
...
<html lang="en">
    ...
    <!-- Mirrored from themazine.com/unify/campus/course-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2019 19:36:19 GMT -->
    <head>
        <meta charset="UTF-8">
        <!-- For IE -->
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-8 col-xs-12 popular-course float-right">
                            <div class="course-style-filter clearfix">
                                ...
                                <ul class="float-right">
                                    <li><a href="http://localhost:8080/3alemniWebsite/ShowFormationServlet" class="tran3s"><i class="fa fa-th-large" aria-hidden="true"></i></a></li>
                                    <li><a href="http://localhost:8080/3alemniWebsite/ShowListeFormationsServlet" class="tran3s active"><i class="fa fa-list" aria-hidden="true"></i></a></li>
                            ...
                            <div>
                                ...
                                <div class="single-course clearfix">
                                    <div class="image-box float-left"><img src="images/course/23.jpg" alt=""></div>
                                    <div class="text float-left">
                                        ...
                                        <h5><a href="course-details.html" class="tran3s"><%= name%></a></h5>
                                        <p><%= description%></p>
                                        <ul class="clearfix">
                                            <li class="float-left">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12  theme-sidebar">
                            ...
                            <form action="#" class="sidebar-search">
                                ...
                                <button class="tran3s"><i class="flaticon-search"></i></button>
                            </form>
                                ...
                                <ul>
                                    ...
                                    <li class="single-news clearfix">
                                        ...
                                        <div class="post float-left">
                                            ...
                                            <p><a href="blog-details.html" class="tran3s"><%=name%></a></p>
                                        </div> <!-- /.post -->
                                    </li>
...
<!-- Mirrored from themazine.com/unify/campus/course-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2019 19:36:30 GMT -->
</html>