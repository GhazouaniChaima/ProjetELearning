<%-- 
    Document   : profile_formateur
    Created on : 19 avr. 2019, 13:24:43
    Author     : chaima
--%>
...
<html lang="en">
    ...
    <!-- Mirrored from themazine.com/unify/campus/teachers-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2019 19:36:46 GMT -->
    <head>
        <meta charset="UTF-8">
        <!-- For IE -->
                    ...
                    <div class="row">
                        <div class="teachers-course-slider">
                            ...
                            <%
                                ...
                                while (cursor.hasNext()) {
                                    BasicDBObject object = (BasicDBObject) cursor.next();
                                    String statutf = object.getString("statut");
                            ...
                            <div class="item">
                                <div class="single-course">
                                    ...
                                    <div class="text">
                                        ...
                                        <h5><a href="course-details.html" class="tran3s"><%=namef%></a></h5>
                                        <ul class="clearfix">
                                            <li class="float-left">
    ...
    <!-- Mirrored from themazine.com/unify/campus/teachers-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Apr 2019 19:36:48 GMT -->
</html>